// boxdefines.c was generated by ProtoGen version 1.4.1.a on Sun Apr 3 12:54:54 2016
...
/*!
 * \brief Encode a ClueInfo_t structure into a byte array
 *
...
void encodeClueInfo_t(uint8_t* data, int* bytecount, const ClueInfo_t* user)
{
    ...
    float64ToBeBytes((double)user->lat, data, &byteindex);

    float64ToBeBytes((double)user->lng, data, &byteindex);
...
/*!
 * \brief Decode a ClueInfo_t structure from a byte array
 *
...
int decodeClueInfo_t(const uint8_t* data, int* bytecount, ClueInfo_t* user)
{
    ...
    user->lat = float64FromBeBytes(data, &byteindex);

    user->lng = float64FromBeBytes(data, &byteindex);
