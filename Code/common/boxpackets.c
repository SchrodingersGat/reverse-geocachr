...
void encodeResetPacket(void* pkt)
{
    ...
    finishReverseGeocachePacket(pkt, byteindex, getResetPacketID());
}
...
int decodeResetPacket(const void* pkt)
{
    ...
    if(numBytes < getResetMinDataLength())
        return 0;
...
/*!
 * \return the minimum data length in bytes for the Reset packet
 */
